...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--bfm_folder', type=str, default='/app/lpips//BFM')
    ...
    def draw_landmark(self, output_coeff):
        self.facemodel.to(self.device)
        lm, persc_proj, rot, trans, face_proj = \
            self.facemodel.compute_for_render_with_params(output_coeff)
        return lm, persc_proj, rot, trans, face_proj
